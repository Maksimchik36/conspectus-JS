...
// console.log(numbers.push(6)); // 6  !!! Возвращает длину массива после добавления элементов.
...
// console.log(numbers.pop()); //  4  !!! возвращает удаленный элемент
// console.log(numbers); // [1, 2, 3]

// console.log(numbers.pop()); //  3  !!! возвращает удаленный элемент
// console.log(numbers); // [1, 2]

// console.log(numbers.pop()); //  2  !!! возвращает удаленный элемент
// console.log(numbers); // [1]

// console.log(numbers.pop()); //  1   !!! возвращает удаленный элемент
// console.log(numbers); // []

// console.log(numbers.pop()); // undefined  !!! Если массив пустой, метод возвращает undefined
// console.log(numbers); // []
